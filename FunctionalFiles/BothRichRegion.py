...
Purpose : 
		...
		Output File : A html file indecating the AT rich region and A html file indecating the GC rich region.
"""
import pdb
import os 
import sys
...
class BothRichRegion(QtGui.QMainWindow):

  def __init__(self, parent=None):
    super(BothRichRegion, self).__init__()
